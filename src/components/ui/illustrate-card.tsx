      ...
      <div className="card">
        ...
        <ul className="card__list">
          <li className="card__list_item">
            ...
            <span className="list_text">Left Click + Drag: Rotate</span>
          </li>
          <li className="card__list_item">
            <span className="check">
              <svg className="check_svg" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="list_text">Right Click + Drag: Pan</span>
          </li>
          <li className="card__list_item">
            <span className="check">
              <svg className="check_svg" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="list_text">Scroll: Zoom</span>
          </li>
          <li className="card__list_item">
            <span className="check">
              <svg className="check_svg" fill="currentColor" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="list_text">Ctrl + Click: Multi-select</span>
          </li>
        </ul>
